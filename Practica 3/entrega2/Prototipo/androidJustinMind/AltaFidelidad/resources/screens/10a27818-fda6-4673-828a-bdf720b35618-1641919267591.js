jQuery("#simulation")
  .on("click", ".s-10a27818-fda6-4673-828a-bdf720b35618 .click", function(event, data) {
          ...
          "blocks": [
            {
              ...
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-10a27818-fda6-4673-828a-bdf720b35618 #s-Label_3 .valign" ],
                    "attributes": {
                      "vertical-align": "middle",
                      "text-align": "left"
                    }
                  },{
                    "target": [ "#s-10a27818-fda6-4673-828a-bdf720b35618 #s-Label_3 span" ],
                    "attributes": {
                      "color": "#6200EE",
                      "text-align": "left",
  ...
  .on("focusin", ".s-10a27818-fda6-4673-828a-bdf720b35618 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-10a27818-fda6-4673-828a-bdf720b35618 #s-Input_5 .valign" ],
                    "attributes": {
                      "vertical-align": "middle"
                    }
                  },{
                    "target": [ "#s-10a27818-fda6-4673-828a-bdf720b35618 #s-Input_5 input" ],
                    "attributes": {
                      "color": "#434343",
                      "text-align": "left",
                      "text-decoration": "none",
  ...
  .on("focusout", ".s-10a27818-fda6-4673-828a-bdf720b35618 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
